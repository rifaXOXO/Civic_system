...
// Fetch all reports submitted by this citizen with type, location info, and status
$sql = "
SELECT 
    r.report_id,
    u.user_name,
    ...
    CASE
        ...
        ELSE 'Unknown'
    END AS report_type,
    -- Status only for Missing Person, Fire Hazard, Lost & Found
    COALESCE(mp.case_status, fh.fire_status, lf.item_status, '-') AS report_status
FROM report r
